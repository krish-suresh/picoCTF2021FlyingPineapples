(module
  ...
  (func $check_flag (;2;) (export "check_flag") (result i32)
    ...
    block $label10
      loop $label12
        ...
        local.set $var122
        local.get $var121 i 
        local.get $var122 len
        i32.lt_s
        local.set $var123 i<len
        i32.const 1
        local.set $var124
        local.get $var123
        local.get $var124
        i32.and
        local.set $var125 i<len
        local.get $var125 
        i32.eqz
        br_if $label10
        local.get $var2
        ...
        block $label11
          ...
          local.get $var141
          i32.add
          local.set $var142 i+1
          local.get $var142
          i32.load8_u offset=1072 char[i+1]
          local.set $var143 char[i+1]
          local.get $var2
          i32.load offset=4
          local.set $var144 i
          local.get $var144
          local.get $var143
          i32.store8 offset=1072 char[i] = char[i+1]
          local.get $var2
          i32.load8_u offset=11
          local.set $var145 tmp
          local.get $var2
          i32.load offset=4
          local.set $var146 i
          i32.const 1
  ...
  (data (i32.const 1024) "\18j|a\118i7\1e_}[hK]=\02\18\14{e6E](\5c3E\099VDB};o@W\7f\0eY\00\00")
)